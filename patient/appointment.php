        ...
        <br><br><br><br>
                ...
                <div class="dashboard-items search-items">
                    <div style="width:100%;">
                        ...
                        <div class="h3-search">Appointment Number:
                            <div class="h1-search">0' . $apponum . '</div>
                        </div>
                        ...
                        <br>';
                                                ...
                                                // 判断当前时间是否已过预约时间
                                                $appointmentTimeStr = $scheduledate . ' ' . $scheduletime;
                                                $appointmentTime = DateTime::createFromFormat('Y-m-d H:i:s', $appointmentTimeStr); // 修复格式
                                                $now = new DateTime();
            ...
            <button class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%">
                <font class="tn-in-text">Cancel Booking</font>
                                                    ...
                                                    echo '<button class="login-btn btn-disabled btn" style="padding-top:11px;padding-bottom:11px;width:100%" disabled>
            <font class="tn-in-text">Cannot Cancel</font>
          </button>';
                                                }
